...
1. PASSO 1: Delegar a "alert_analyzer" para análisis inicial
2. PASSO 2: Si VERDADEIRO POSITIVO → "threat_analyzer" | Si FALSO POSITIVO → saltar a paso 3
3. PASSO 3: Delegar a "notification_agent" para envío final
